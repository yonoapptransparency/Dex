...
export const mockSettings: GlobalSettings = {
  ...
  "ticker_text": "RummyDex is the ultimate game directory. Access hand-tested reviews, verified secure links, and daily news to elevate your mobile experience.",
  ...
  "website_faqs": [
    {
      "answer": "A: RummyDex is an independent digital directory and informational hub. We catalog, review, and provide structured breakdowns of premium casual games, tabletop simulators, and digital utility apps. We are your centralized platform for discovering top-tier mobile entertainment.",
      "question": "Q1: What exactly is RummyDex?"
    },
    {
      "question": "Q2: Does RummyDex host or provide direct APK downloads?",
      "answer": "A: No. We operate strictly as a secure informational bridge. Instead of hosting files, we provide rigorously tested reviews and generate verified, secure outbound links that route you directly to the official third-party developer's source. This guarantees you are always downloading the legitimate, safest version of an app."
    },
    {
      "answer": "A: We do not rely on automated scraping or blind listings. Every application on our directory undergoes a strict, hands-on testing process by our team. We physically test the software for hardware optimization, user interface fluidity, and overall entertainment value to ensure complete neutrality and accuracy in our reviews.",
      "question": "Q3: How do you test and review the applications listed here?"
    },
    {
      "answer": "A: Absolutely not. RummyDex maintains a strict, zero-tolerance policy against unauthorized real-money gaming mechanics. Our directory is built purely for safe, casual digital retreats. If an app alters its mechanics post-launch to include RMG, it is permanently removed from our index under our 100% removal guarantee.",
      "question": "Q4: Do you feature real-money gaming (RMG) or betting apps?"
    },
    {
      "question": "Q5: Do I need to create an account or pay to use the directory?",
      "answer": "A: No. RummyDex is a 100% free, open-access platform. You do not need to register, provide an email address, or pay any subscription fees to read our reviews, watch our video snippets, or access our verified download links."
    },
    {
      "answer": "A: Our platform is a highly active ecosystem. The app vault is continuously monitored and updated with new, hand-tested applications, while our News Hub provides daily updates on industry shifts, developer patches, and platform changes.",
      "question": "Q6: How often is the app directory and news hub updated?"
    }
  ],
  "developers": [],
  ...
  "last_updated": "2026-08-02T07:21:54.144Z",
  "seo_keywords": "",

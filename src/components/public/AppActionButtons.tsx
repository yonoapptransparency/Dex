...
export default function AppActionButtons({
  ...
  const handleDownload = () => {
    // Navigate seamlessly to the dedicated secure moreinfo gateway page
    navigate(`/moreinfo/${encodeURIComponent(app.slug || app.id)}`);
  };
        ...
        {isActuallyComingSoon ? (
          ...
          <div className="w-full flex flex-col items-center gap-1.5">
            <button 
              ...
              className="w-full premium-action-btn premium-action-btn-blowing cursor-pointer text-white !text-white font-bold py-2.5 px-5 rounded-xl flex flex-col items-center justify-center gap-0.5 transition-all text-sm shadow-md h-[44px]"
            >

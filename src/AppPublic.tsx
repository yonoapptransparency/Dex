        ...
        <div className="w-full h-full">
          <ErrorBoundary key={location.pathname}>
            <Routes location={location}>
              ...
              <Route path="/new-apps" element={<Suspense fallback={<LoadingScreen />}><Home /></Suspense>} />
              <Route path="/category/:category" element={<Suspense fallback={<LoadingScreen />}><Home /></Suspense>} />
              <Route path="/category/:category/*" element={<Suspense fallback={<LoadingScreen />}><Home /></Suspense>} />
              <Route path="/categories" element={<Suspense fallback={<LoadingScreen />}><Home /></Suspense>} />
              <Route path="/categories/:category" element={<Suspense fallback={<LoadingScreen />}><Home /></Suspense>} />

      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 py-0 sm:py-3 pb-16 sm:pb-24 overflow-x-hidden relative">
        <div className="w-full h-full">
          <Routes location={location}>
            ...
            {/* Legacy path support handled by direct redirection to canonical /app/:slug */}
            <Route path="/info/:slug" element={<LegacyRedirect />} />
            <Route path="/moreinfo/:slug" element={<LegacyRedirect />} />
            <Route path="/download/:slug" element={<LegacyRedirect />} />
            <Route path="/moredetail/:slug" element={<LegacyRedirect />} />

      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 py-0 sm:py-3 pb-16 sm:pb-24 overflow-x-hidden relative">
        <div className="w-full h-full">
          <Routes location={location}>
            ...
            <Route path="/app/:slug" element={<Suspense fallback={null}><AppDetails /></Suspense>} />
            <Route path="/app/:slug/*" element={<Suspense fallback={null}><AppDetails /></Suspense>} />
            <Route path="/moreinfo/:slug" element={<Suspense fallback={null}><GatewayPage /></Suspense>} />
            <Route path="/info/:slug" element={<Suspense fallback={null}><GatewayPage /></Suspense>} />
            <Route path="/gateway/:slug" element={<Suspense fallback={null}><GatewayPage /></Suspense>} />
            <Route path="/download/:slug" element={<Suspense fallback={null}><GatewayPage /></Suspense>} />
            <Route path="/moredetail/:slug" element={<Suspense fallback={null}><GatewayPage /></Suspense>} />
            ...
            <Route path="/video/:slug" element={<Suspense fallback={null}><VideoDetailPage /></Suspense>} />
            ...
            <Route path="/:slug" element={<Suspense fallback={null}><FallbackRouteMatcher /></Suspense>} />
            
            <Route path="*" element={<Suspense fallback={null}><FallbackRouteMatcher /></Suspense>} />
          </Routes>
        </div>
      </main>

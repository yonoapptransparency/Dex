        ...
        {filteredNews.map((item) => (
          ...
          >
            <Link 
              ...
              className="block w-full aspect-video rounded-2xl overflow-hidden mb-6 shadow-sm border border-black/5 dark:border-white/10 bg-zinc-100 dark:bg-zinc-800 relative"
            >
              <img 
